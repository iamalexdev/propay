...
🔄 *Actualizado:* {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}"""
        ...
        send_group_notification(f"🚨 *Error en sistema de tasas:* {str(e)}")
...
def run_bot():
    ...
    try:
        ...
        send_group_notification(f"🚨 *Error crítico en el bot:* {e}")
        time.sleep(10)
        run_bot()  # Reiniciar
